(function (global, factory) {
  ...
  function injectlandingpage(url, waitFor, callback) {
    if (isNil(url)) {
      console.error("Inject landingpage error");
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectlandingpage(this.settings.plyr.css, "Plyr");
    var url = data.href;
    ...
    injectlandingpage(this.settings.plyr.js, "Plyr", function () {
